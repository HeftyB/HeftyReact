...
export default function Nav() {
    return (
        <>
            <nav className="bg-gray-400 px-3 pt-2 p-1 rounded">
                <div className="container mx-auto flex flex-wrap items-end justify-between">
                    <div class="w-8">
                        <img src={logo} alt="" className="animate-bounce" />
                    </div>

                    <div className="mid flex items-end justify-evenly w-3/12 text-lg">
                        <div class="bg-blue-800 hover:bg-red-400 pt-2 px-4 rounded-lg align-middle">
                            Home
                        </div>
